...
/* App Module */
var user_module_app = angular.module('user_module_app', ['ui.router','angularValidator','ngCookies','ui.bootstrap','ngFileUpload','ui.tinymce']);
...
user_module_app.controller('addcontent', function($compile,$scope,$state,$http,$cookieStore,$rootScope,Upload,$sce,$stateParams,$window) {
...
user_module_app.controller('contentlist', function($scope,$state,$http,$cookieStore,$rootScope,$uibModal) {
...
user_module_app.controller('editcontent', function(contentservice,$compile,$scope,$state,$http,$cookieStore,$rootScope,Upload,$sce,$stateParams,$uibModalInstance,items) {
...
user_module_app.controller('addrole', function($compile,$scope,$state,$http,$cookieStore,$rootScope,$sce,$stateParams,$window,contentservice) {
...
user_module_app.controller('rolelist', function($compile,$scope,$state,$http,$cookieStore,$rootScope,$sce,$stateParams,$window,$uibModal,contentservice) {
...
user_module_app.controller('editrole', function($compile,$scope,$state,$http,$cookieStore,$rootScope,$sce,$stateParams,$window,contentservice) {
    ...
    $http({
        method: 'GET',
        async: false,
        url: $scope.adminUrl + 'roledetails/'+$scope.id,
...
user_module_app.controller('ModalInstanceCtrl1', function ($scope,$state,$cookieStore,$http,$uibModalInstance,$rootScope,Upload,$uibModal,$timeout) {
    ...
    $scope.role_delete = function(){
        ...
        $http({
            ...
            data    : $.param({id: $scope.rolelist[idx]._id}),  // pass in data as strings
            headers : { 'Content-Type': 'application/x-www-form-urlencoded' }
        }) .success(function(data) {
            $rootScope.stateIsLoading = false;
            if(data=='success'){
